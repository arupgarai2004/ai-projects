...
- [1.0 Basic](</1-python basic/1.0-basic.ipynb>)
- [1.1 Variables](</1-python basic/1.1-Variables.ipynb>)
- [1.2 Datatypes](</1-python basic/1.2-Datatypes.ipynb>)
- [1.3 Operators](</1-python basic/1.3-operators.ipynb>)
- [Test Notebook](</1-python basic/test.ipynb>)
- [Requirements File](</1-python basic/requiremnt.txt>)
